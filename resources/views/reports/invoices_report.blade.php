        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('Search_invoices')}}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}Search_invoices


                    <div class="col-lg-3">
                        <label class="rdiobox">
                            {{-- هحط اي دي عشان تغير الشكل لو بروقم الفانورة او بنوع الفاتورة هنا وتحت بردو  --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                required>
                                {{--{{ $type ?? 'حدد نوع الفواتير' }}  دي معناها لو التايب موجود اتبعتلة يعني يكتبه لو لاء يكتب الجمله دي وهكذا تحت  --}}
                                <option value="{{ $type ?? 'حدد نوع الفواتير' }}" selected>
                                    {{ $type ?? 'حدد نوع الفواتير' }}
                                </option>
                                {{-- value   القيمة الي ف الداتا بيز  --}}
...
<script>
    $(document).ready(function() {
        ...
        $('#invoice_number').hide(); // دي عشان اول ميعمل ريفرش الديف بتاع السيرش بالرقم ميظهر ويظهر بقا لم اغير من البوتون 
     // الي جاي كل فكرتة لم الدوس ع الايدي دا  اخفي كذا وباين الاقي لو دوست ع دا بين كذا واخفي كذا 
