...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <style>
            ...
            .social-icons a:hover {
                color: #0077b5;
                /* تغيير اللون عند المرور على الأيقونة (لون أزرق للينكد إن كمثال) */
            }
            ...
            .social-icons a:hover i {
                transform: scale(1.2);
                /* تكبير الأيقونة عند التمرير عليها */
            }
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ route('invoices.index') }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('Partially_paid_invoices') }}">الفواتير المدفوعة جزئيا
                                </a></li>
                        @endcan
                        ...
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('arshive.index') }}"> الارشيف</a></li>
                        @endcan
            ...
            @can('اضافة منتج')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">Add</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
