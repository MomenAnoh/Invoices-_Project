...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافة</h4><span
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            <tbody>
                                {{--  حركة حلوة عشان الانكريمن يبقا بمزاجي بالعافية --}}
                                <?php $i = 0; ?>
                                @foreach ($get as $ge)
                                    <?php $i++; ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $ge->id }}" data-section="{{ $ge->section }}"
                                                data-description="{{ $ge->description }}" data-toggle="modal"
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('section.store') }}" method="post">
                            @csrf
                            <input type="text" class ="form-control" name="section" placeholder="اسم القسم"><br><br>
                            <input type="text" class ="form-control" name="description" placeholder="ملاحظات"><br><br>

                            <!-- class ="form-control" بتخلي الحقل مالي المكان -->
...
@section('js')
    ...
    <script>
        ...
        $('#exampleModal2').on('show.bs.modal', function(event) {
            // شرخ=ح بقا الكلام دا الي جاي دا معناه اعملي فاريبل اسمة كذا هاتلي بقا كذا وخزنة فيه ويتم عرضة في الموديلا دا الجزئ الي تحت
