                        ...
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ App\Models\Invoice::where('Status', '=', 'غير مدفوعة')->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    {{ number_format((App\Models\Invoice::where('Status', '=', 'غير مدفوعة')->count() / App\Models\Invoice::count()) * 100, 2) }}
                                </span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ App\Models\Invoice::where('Status', '=', 'مدفوعة')->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    {{ number_format((App\Models\Invoice::where('Status', '=', 'مدفوعة')->count() / App\Models\Invoice::count()) * 100, 2) }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ App\Models\Invoice::where('Status', '=', 'مدفوعة جزئيا')->count() }}</p>

                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span
                                    class="text-white op-7">{{ number_format((App\Models\Invoice::where('Status', '=', 'مدفوعة جزئيا')->count() / App\Models\Invoice::count()) * 100, 2) }}
                                    %</span>
                            </span>
                        </div>
                    </div>
